...
async def create_finetune_job(request: FinetuneRequest):
    ...
    with tracer.start_as_current_span("finetune.create_job") as span:
        span.set_attribute("model.base", request.base_model)
        span.set_attribute("training.method", request.method.value)
        ...
        telemetry.record_job_created(request.base_model, request.method.value)
        ...
        try:
            ...
            telemetry.record_job_failed(request.base_model, request.method.value)
